...
class ChatRepository {
    ...
    OpenAIChatCompletionModel chatCompletion =
      ...
      messages: [
        OpenAIChatCompletionChoiceMessageModel(
          content:
              "あなたは${languageType}話者のAです。${this.languageType}で、Aさんであるあなたから始まりBさんから終わる会話を一件だけ出力してください。",
        ...
        OpenAIFunctionModel.withParameters(
          ...
          parameters: [
            OpenAIFunctionProperty.array(
                name: "conversations",
                items: OpenAIFunctionProperty.object(name: "", properties: [
  ...
  Future<List<Conversation>> continueConversation(
    ...
    OpenAIChatCompletionModel chatCompletion =
      ...
      messages: [
        OpenAIChatCompletionChoiceMessageModel(
          content:
              "あなたは${languageType}話者のAです。今まであなたがBさんと${this.languageType}での会話履歴が与えられるので、それを元に${this.languageType}でBさんとの会話を続けてください。会話は1回だけ続けてください。",
      ...
      functionCall:
          FunctionCall.forFunction('get_localingo_continue_conversation'),
    );
    FunctionCallResponse? response =
        chatCompletion.choices.first.message.functionCall;
    if (response != null && response.arguments != null) {
